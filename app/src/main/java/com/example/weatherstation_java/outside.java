...
public class outside extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewResult = findViewById(R.id.outTextViewOutJson);
    ...
    private void jsonParse(){
        String url="http://192.168.1.219/pogodynka/json_out.php";
        //String url="http://www.json-generator.com/api/json/get/ceDeuFXsia?indent=2";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    JSONArray jsonArray = response.getJSONArray("zewnatrz");
